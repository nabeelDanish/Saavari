...
import com.savaari.savaari_driver.ride.adapter.VehicleSelectAdapter;
...
public class RideActivity
    ...
    // Util Variables
    private final String TAG = com.savaari.savaari_driver.ride.RideActivity.this.getClass().getCanonicalName();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        LocalBroadcastManager.getInstance(com.savaari.savaari_driver.ride.RideActivity.this).registerReceiver(locationUpdateReceiver, new IntentFilter("Update"));
        ...
        // Setting Stuff
        if (USER_ID == -1) {
            Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "Sorry. We can not authenticate you", Toast.LENGTH_LONG).show();
        }
        else {
            ...
            // Getting View Model
            rideViewModel = new ViewModelProvider(this, new com.savaari.savaari_driver.ride.RideViewModelFactory(USER_ID,
                    ((SavaariApplication) this.getApplication()).getRepository())
            ).get(com.savaari.savaari_driver.ride.RideViewModel.class);
    ...
    private void observeStatusFlag() {
        rideViewModel.getDriverStatus().observe(this, status ->
        {
            if (status != null) {
                switch (status) {
                    case com.savaari.savaari_driver.ride.RideViewModel.OFFLINE: {
                        loadUserData();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.DATA_LOAD_SUCCESS: {
                        onUserDataLoaded();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.DATA_LOAD_FAILURE: {
                        onUserDataFailure();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.VEHICLE_SELECTED_SUCCESS: {
                        onVehicleSelected();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.VEHICLE_SELECTED_FAILURE: {
                        onVehicleFailure();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.MARKED_ACTIVE_SUCCESS: {
                        onMarkActive();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.MARKED_ACTIVE_FAILURE: {
                        onMarkActiveFailure();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.MATCHMAKING_STARTED_SUCCESS: {
                        onMatchmakingStarted();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.MATCHMAKING_STARTED_FAILURE: {
                        onMatchmakingFailure();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.RIDE_REQUEST_FOUND: {
                        onRideRequestFound();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.CONFIRM_RIDE_SUCCESS: {
                        onConfirmRideSuccess();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.CONFIRM_RIDE_FAILURE: {
                        onConfirmRideFailure();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.NEAR_PICKUP: {
                        onNearPickup();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.PICKUP_MARK_SUCCESS: {
                        onNearPickupSuccess();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.PICKUP_MARK_FAILURE: {
                        onNearPickupFailure();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.RIDE_STARTED_SUCCESS: {
                        onStartRideSuccess();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.RIDE_STARTED_FAILURE: {
                        onStartRideFailure();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.NEAR_DEST: {
                        onNearDestination();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.DEST_MARK_SUCCESS: {
                        onConfirmEndRideSuccess();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.DEST_MARK_FAILURE: {
                        onConfirmEndRideFailure();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.PAYMENT_SUCCESS: {
                        onPaymentSuccess();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.PAYMENT_FAILURE: {
                        onPaymentFailure();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.FEEDBACK_SUCCESS: {
                        onFeedbackSuccess();
                        break;
                    }
                    case com.savaari.savaari_driver.ride.RideViewModel.FEEDBACK_FAILURE: {
                        onFeedbackFailure();
                        break;
                    }
                }
    ...
    private void onVehicleFailure() {
        ...
        // UI
        progressBar.setVisibility(View.INVISIBLE);
        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "Vehicle Selection Failed!", Toast.LENGTH_SHORT).show();
    }
    ...
    private void onMarkActiveFailure() {
        ...
        matchmakingControllerBtn.setVisibility(View.VISIBLE);
        matchmakingControllerBtn.setText("ACTIVE");
        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "Mark Active Failed!", Toast.LENGTH_SHORT).show();
    ...
    private void onMatchmakingFailure() {
        // UI
        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "Matchmaking failed", Toast.LENGTH_SHORT).show();
    ...
    private void onConfirmRideSuccess() {
        ...
        if (isTakingRide) {
            ...
            com.savaari.savaari_driver.entity.Location tempLocation = temp.getCurrentLocation();
    ...
    private void onConfirmRideFailure() {
        // UI
        progressBar.setVisibility(View.INVISIBLE);
        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "Confirm Ride failed!", Toast.LENGTH_SHORT).show();
        rideDetailsPanel.setAnimation(Util.outToBottomAnimation());
        rideDetailsPanel.setVisibility(View.GONE);
    ...
    private void onNearPickupFailure() {
        // UI
        progressBar.setVisibility(View.INVISIBLE);
        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "Pickup failed!", Toast.LENGTH_SHORT).show();
    ...
    private void onStartRideFailure() {
        // UI
        progressBar.setVisibility(View.INVISIBLE);
        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "Ride Started Failed!", Toast.LENGTH_SHORT).show();
    }
    ...
    private void onConfirmEndRideFailure() {
        // UI
        progressBar.setVisibility(View.INVISIBLE);
        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "End Ride Failed!", Toast.LENGTH_SHORT).show();
    ...
    private void onPaymentFailure() {
        // UI
        progressBar.setVisibility(View.INVISIBLE);
        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "Payment Failed", Toast.LENGTH_SHORT).show();
    }
    // --------------------------------------------------------------------------------------------
    ...
    private void onUserDataFailure() {
        // UI
        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "Data could not be loaded", Toast.LENGTH_SHORT).show();
        matchmakingControllerBtn.setEnabled(false);
        matchmakingControllerBtn.setText("SELECT VEHICLE");
        rideStatusBar.setText("You're Offline");
    ...
    private void loadUserLocations()
    {
        rideViewModel.isLiveUserLocationsLoaded().observe(this, aBoolean -> {
            if (aBoolean)
            {
                ArrayList<com.savaari.savaari_driver.entity.Location> mUserLocations = rideViewModel.getUserLocations();
                ...
                Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "User locations loaded!", Toast.LENGTH_SHORT).show();
            }
            else
            {
                Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "User locations could not be loaded", Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                        ((place.getAddress() == null) ? "" : place.getAddress()) : place.getName());
    ...
    private void initMap() {
        ...
        mapFragment.getMapAsync(com.savaari.savaari_driver.ride.RideActivity.this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "Map is ready", Toast.LENGTH_SHORT).show();
    ...
    private void moveCamera(LatLng latLng, boolean oldZoom) {
        if (oldZoom)
            googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, com.savaari.savaari_driver.ride.RideActivity.DEFAULT_ZOOM));
        else
                ...
                location.addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (currentLocation != null) {
                            driverLocation = new com.savaari.savaari_driver.entity.Location();
                        ...
                        try {
                            ...
                            LocationUpdateUtil.saveUserLocation(rideViewModel.getDriver().getCurrentLocation().toLatLng(), com.savaari.savaari_driver.ride.RideActivity.this);

                            // Starting Background Location Service
                            ActivityManager manager = (ActivityManager) getSystemService(ACTIVITY_SERVICE);
                            LocationUpdateUtil.startLocationService(manager, com.savaari.savaari_driver.ride.RideActivity.this);
                        ...
                        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                    }
                });
            }
    ...
    private void addPolylinesToMap(final DirectionsResult result, boolean sourceToDest){
        ...
        new Handler(Looper.getMainLooper()).post(() -> {
            ...
            if (sourceToDest) {
                ...
                destinationPolyline.setColor(ContextCompat.getColor(com.savaari.savaari_driver.ride.RideActivity.this, R.color.maps_blue));
                ...
                pickupPolyline.setColor(ContextCompat.getColor(com.savaari.savaari_driver.ride.RideActivity.this, R.color.success_green));
    ...
    public boolean isServicesOK() {
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(com.savaari.savaari_driver.ride.RideActivity.this);
        ...
        if (available == ConnectionResult.SUCCESS) {
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(com.savaari.savaari_driver.ride.RideActivity.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
            return true;
        }
        else {
    ...
    {
        final AlertDialog.Builder builder = new AlertDialog.Builder(com.savaari.savaari_driver.ride.RideActivity.this);
        builder.setMessage("Open Google Maps?")
                ...
                .setPositiveButton("Yes", (dialog, id) ->
                {
                    ...
                    try
                    {
                        if (mapIntent.resolveActivity(com.savaari.savaari_driver.ride.RideActivity.this.getPackageManager()) != null)
                        {
                    ...
                    } catch (NullPointerException e)
                    {
                        ...
                        Toast.makeText(com.savaari.savaari_driver.ride.RideActivity.this, "Couldn't open map", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case (R.id.nav_your_documents):
                i = new Intent(com.savaari.savaari_driver.ride.RideActivity.this, RegisterActivity.class);
            ...
            case (R.id.nav_settings):
                i = new Intent(com.savaari.savaari_driver.ride.RideActivity.this, SettingsActivity.class);
                startActivity(i);
                break;
        }
        return true;
