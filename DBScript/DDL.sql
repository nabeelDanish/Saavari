...
(
     ...
     `DIST_TRAVELLED` DECIMAL(10, 3) DEFAULT 0,
...
CREATE TABLE `ride_hailing`.`COMPLAINTS`
(
     `COMPLAINT_ID` INT(8) UNSIGNED NOT NULL AUTO_INCREMENT,
     `USER_ID` INT(10) UNSIGNED NOT NULL,
     `RIDE_ID` INT(10) UNSIGNED NOT NULL,
     `USER_TYPE` INT(1) UNSIGNED NOT NULL DEFAULT 0,
     `CATEGORY` INT(1) UNSIGNED DEFAULT 0,
     `DESC` TEXT NOT NULL,
     `STATUS` INT(1) NOT NULL DEFAULT 0,
     ...
     INDEX `USER_COMPLAINTS`(`USER_ID`, `USER_TYPE`),
     INDEX `COMPLAINTS_FOR`(`RIDE_ID`)
) ENGINE = InnoDB;
